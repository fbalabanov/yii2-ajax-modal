...
or add
```
"fbalabanov/yii2-ajax-modal": "^1.0"
```
...
### View
```php
use fbalabanov\widgets\modal\ModalAjax;
...
```html
<a class="btn" href="/site/update?id=10" data-title="Edit ID-10" title="Edit ID-10" data-scenario="hello">Hello</a>
<a class="btn" href="/site/update?id=20" data-title="Edit ID-20" title="Edit ID-20" data-scenario="goodbye">Goodbye</a>
```
